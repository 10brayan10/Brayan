  ...
  <body>
    ...
    <div class="btn-group center">
        	...
        	<a href="registro.html"><button>Registro entrada/salida</button></a>
  			<a href="php/consultas.html"><button>Consultas y reportes</button></a>
  	</div>
    -->
  	<br>
  	<div class="form center">
        ...
        <h4><b>Registro de nuevo personal</b></h4>
  	</div>
  	...
  	<div class="container">
  		<div class="form">
  			<form action="{{url('/newusuarios')}}" method="POST" name="usuario_form" id="usuario_form">
         @csrf
          <center><h5><b>Ingrese sus datos para registrar al nuevo personal</b></h5><br></center>
  			...
  			<div class="center">
  			<button type="submit" form="usuario_form" value="Submit" >Aceptar</button>
  		</div>
